...
import { LeadConsolePanel } from '@/components/LeadConsolePanel';
...
export function LiveFeed({ workspaceId }: LiveFeedProps) {
  ...
  return (
    <aside className="w-80 bg-mc-bg-secondary border-l border-mc-border flex flex-col">
      ...
      <MissionPlannerPanel workspaceId={workspaceId} />
      <LeadConsolePanel workspaceId={workspaceId} />
